...
def load_pseudo_label(data_dir_skeletons, data_true_dir, data_pseudo_dir, first_label, true_labels, save_dir):
...
def pseudo_data_set_info(dt, dp, save_dir):
    ...
    output_filepath = os.path.join(save_dir, 'pseudo_data_metrics.json')
    with open(output_filepath, 'w') as f:
        json.dump(metrics_dict, f, indent=4)