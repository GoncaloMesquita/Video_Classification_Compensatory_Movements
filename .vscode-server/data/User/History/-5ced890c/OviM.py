        ...
        for batch_idx, (inputs, targets, lengths, inputs2) in enumerate(val_loader):
            ...
            if saliency_map and mode == 'testing' :
                if method == 'ig':
                    ...
                    attributions.append(integrated_gradients(inputs, model, lengths, 0, baseline=None, steps=10))
...
def integrated_gradients(inputs, model, lengths, target_label_idx, baseline=None, steps=10):
    if baseline is None:
