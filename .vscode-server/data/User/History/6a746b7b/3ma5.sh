...
python3 main.py  \
    ...
    --checkpoint Results/SkateFormer/SkateFormer_bs16_lr3.190e-05_hs1_th0.200_0.400_0.150_0.350_0.150_0.350_eta3.670e-06_ptTrue/saved_models/SkateFormer_0_best.pth \
    --save_dir Results/ \
    --method vg \
    --treshold_labels 0.7 2\
    --n_device 0
...
#     --data_trial trials \
#     --data_true_dir dataset/frame_level_labels.pt \
#     --data_pseudo_dir dataset/pseudo_labels/SkateFormer/method2/vg_1.5_2.5/pseudo_labels_1.pkl \
#     --save_dir Results/ \
#     --trainII \
#     --first_label \
#     --n_device 0
