...
python3 main.py  \
    ...
    --checkpoint Results/LSTM/LSTM_newdata_cross_bs16_lr6.161e-04_hs192_th0.500_0.400_0.500_0.350_0.300_0.100_eta9.548e-05_ptTrue/saved_models/LSTM_10_best.pth \
    --save_dir Results/ \
    --saliency_map \
    --method vg \
    --treshold_labels 4.5 \
...
#     --data_trial trials \
#     --data_true_dir dataset/frame_level_labels.pt \
#     --data_pseudo_dir dataset/pseudo_labels/LSTM/vanilla_gradients_4.5/pseudo_labels.pkl \
#     --save_dir Results/ \
#     --trainII \
#     --first_label \
#     --n_device 1
