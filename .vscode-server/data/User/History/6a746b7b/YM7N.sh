...
#     --data_label dataset/Toronto_Rehab_labels.pt \
#     --data_skeletons dataset/Toronto_Rehab_skeletons.pt \
#     --checkpoint Results/Toronto/SkateFormer/SkateFormer_bs16_lr4.000e-04_hs192_th0.500_eta1.000e-05_ptFalse/saved_models/SkateFormer_0_best.pth \
#     --save_dir Results/ \
...
python3 main.py  \
    ...
    --data_label dataset/MMAct_data_label.pt \
    --data_skeletons dataset/MMAct_data_person.pt \
    --checkpoint Results/MMAct/moment/moment_bs16_lr1.000e-04_hs192_th0.500_0.100_eta1.000e-05_ptFalse/saved_models/moment_0_best.pths \
    --save_dir Results/ \
    --method ig \
    --treshold_labels 4.5 \
    --n_device 3
...
#     --data_label dataset/MMAct_data_label.pt \
#     --data_skeletons dataset/MMAct_data_person.pt \
#     --data_true dataset/MMAct_data_label_frame_level.pt \
#     --data_pseudo_dir dataset/pseudo_labels/MMAct/AcT/method1/vg_3.7/pseudo_labels_1.pkl \
#     --save_dir Results/ \
#     --trainII \
#     --n_device 3