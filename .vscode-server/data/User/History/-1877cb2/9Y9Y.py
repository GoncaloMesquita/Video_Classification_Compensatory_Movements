...
def create_model(model, val_loader, criterion, device, mode, save_dir, model_name, thresholds, optuna, saliency_map, scaler, patient, treshold_labels, method):
    ...
    if model_name == 'LSTM':
        ...
        if mode == 'train':
            ...
            model = Moment_II(num_labels, dropout)
        ...
        if mode == 'train':
            ...
            model.dinov2.encoder.layer = torch.nn.ModuleList(model.dinov2.encoder.layer[:4] + model.dinov2.encoder.layer[12:])
