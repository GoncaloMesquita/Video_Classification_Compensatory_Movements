...
def train_I( args):
    ...
    for i , (X_t, y_t, X_test, y_test) in enumerate (cross_val_data):
        ...
        if args.mode == "train" or mode == "test":
            ...
            pseudo_labels(model, test_loader, criterion, device, "testing", args.save_dir, args.model_name, args.threshold, False, args.saliency_map, scaler, i, args.treshold_labels, args.method))
