...
from utils.pseudo_labels import pse_labels
...
def train_I( args):
    ...
    for i , (X_t, y_t, X_test, y_test) in enumerate (cross_val_data):
        ...
        if args.mode == "train" or mode == "test":
            ...
            pse_labels(model, test_loader, device, "testing", args.save_dir, args.model_name, scaler, i, args.treshold_labels, args.method)
            ...
            if i in args.vis_patients:
                ...
                vis(model, test_loader, criterion, device, "testing", args.save_dir, args.model_name, scaler, i, args.treshold_labels, args.method)
