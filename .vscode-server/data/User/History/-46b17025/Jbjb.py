...
def train_I(args):
    ...
    for i , (X_t, y_t, X_test, y_test) in enumerate (cross_val_data):
        ...
        if args.mode == "train" or mode == "test":
            ...
            pseudo_labels(model, test_loader, device, args.save_dir, args.model_name, scaler, i, args.treshold_labels, args.method)

                    model, test_loader, device, save_dir, model_name, patient, treshold_labels, method
