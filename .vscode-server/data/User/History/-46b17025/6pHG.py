    ...
    for i , (X_t, y_t, X_test, y_test) in enumerate (cross_val_data):
        ...
        if args.mode == "train" or mode == "test":
            ...
            if i in args.vis_patients:
                ...
                visualization(model, test_loader, device, args.model_name, scaler, i, args.treshold_labels, args.method)
            model, test_loader, criterion, device, model_name, patient, method, trials, n_batch
