...
def metrics(targets, predictions, mode, output_dir):
    ...
    precision_per_label = precision_score(targets, predictions, average="binary", zero_division=0)
    recall_per_label = recall_score(targets, predictions, average="binary", zero_division=0)
    f1_per_label = f1_score(targets, predictions, average="binary", zero_division=0)
