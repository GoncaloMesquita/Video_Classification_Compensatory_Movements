...
class MomentDino(nn.Module):
    def __init__(self, num_classes, dropout, input_size, seq_length): 
        ...
        self.moment_projection = nn.Linear(embedding_moment, 1024)
        self.dino_projection = nn.Linear(embedding_dino, 1024)
    ...
    def forward(self, x1, x2):
        ...
        moment_embeddings = self.moment_projection(moment_embeddings)
        ...
        dino_embedding = self.dino_projection(dino_embedding)
