...
class MomentDino(nn.Module):
    def __init__(self, num_classes, dropout, input_size, seq_length): 
        ...
        self.dino_processor = AutoModel.from_pretrained("facebook/dino-vitb16", output_attentions=True)
        self.dinov2 = AutoImageProcessor.from_pretrained("facebook/dino-vitb16")
    ...
    def forward(self, x1, x2):
        ...
        for frame in x2:
            ...
            frame_input = self.dino_processor(images=frame, return_tensors="pt")
