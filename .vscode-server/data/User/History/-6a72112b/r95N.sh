#!/bin/bash
source .conda/envs/newenv/bin/python

# Set environment variables for distributed training
export MASTER_ADDR=localhost
export MASTER_PORT=12355
export WORLD_SIZE=2  # Adjust this based on the total number of processes
...
python3 --nproc_per_node=2 main.py \
    --model_name $model_name \
    --input_size 99 \
    --hidden_size 192 \
    --num_layers 1 \
    --num_labels 6 \
    --dropout 0.1820088098820616 \
    --batch_size 128 \
    --epochs 250 \
