    ...
    for i in range(1):
        ...
        if args.mode == "train":
            ...
            for epoch in range(args.epochs):
                ...
                train_loss = training(model, train_loader, optimizer, criterion, device, args.save_dir)
                ...
                val_loss, targets , predictions = validate(model, val_loader, criterion, device, "Validation:", args.save_dir)
        ...
        model.to(device)
        _, targets , predictions = validate(model, test_loader, criterion, device, "Testing:", args.save_dir)  
