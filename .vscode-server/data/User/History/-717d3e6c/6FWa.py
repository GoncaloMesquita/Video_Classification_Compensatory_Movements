...
def visaulization(model, test_loader, criterion, device, model_name, patient, treshold_labels, method, trials, batch_index):

    
    if method == 'ig':
        gradient_integrated(test_loader, criterion, model_name, model, patient, device, treshold_labels, trials)
    
    elif method == 'vg':
        append(vanilla_gradients(test_loader, criterion, model_name, model, patient, device, treshold_labels, trials, batch_index))
