...
def visaulization(model, test_loader, criterion, device, model_name, patient, treshold_labels, method):

    
    if method == 'ig':
        gradient_integrated(test_loader, criterion, model_name, model, patient, device, treshold_labels)
    
    elif method == 'vg':
        append(vanilla_gradients(test_loader, criterion, model_name, model, patient, device, treshold_labels)
