...
def visaulization(model, test_loader, criterion, device, model_name, patient, treshold_labels, method, trials):
    ...
    if method == 'ig':
        ...
        append(vanilla_gradients(test_loader, criterion, model_name, model, patient, device, treshold_labels, trials)
