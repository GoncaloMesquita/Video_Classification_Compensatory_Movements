...
def create_model(model_name, input_size, hidden_size, num_layers, num_labels, dropout, checkpoint, mode, pretrained, device, learning_rate, eta, epochs, seq_size, n_dim):
    ...
    if model_name == 'LSTM':
        ...
        if mode == "train":
            ...
            model = SkateFormer( in_channels=n_dim, depths=(2, 2, 2, 2), channels=(96, 192, 192, 192), num_classes=num_labels,
                 embed_dim=96, num_people=1, num_frames=1876, num_points=input_size//n_dim, kernel_size=7, num_heads=32,
        ...
        if mode == 'test':  
            ...
            model = SkateFormer( in_channels=n_dim, depths=(2, 2, 2, 2), channels=(96, 192, 192, 192), num_classes=num_labels,
                 embed_dim=96, num_people=1, num_frames=769, num_points=input_size//n_dim, kernel_size=7, num_heads=32,
