    ...
    if model_name == 'LSTM':
        ...
        if mode == "train":
            ...
            model = SkateFormer( in_channels=3, depths=(2, 2, 2, 2), channels=(96, 192, 192, 192), num_classes=6,
                 embed_dim=96, num_people=1, num_frames=770, num_points=33, kernel_size=7, num_heads=32,
                 type_1_size=(11,11), type_2_size=(11,11), type_3_size=(11,11), type_4_size=(11,11),
