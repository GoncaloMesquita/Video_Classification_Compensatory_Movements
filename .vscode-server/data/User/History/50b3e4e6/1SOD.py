...
class PatchClassEmbedding(nn.Module):
    ...
    def __init__(self, d_model, n_patches, pos_emb=None):
        ...
        self.position_embedding = nn.Embedding(2000, self.d_model)
    ...
    def forward(self, inputs, mask=None):
        ...
        if self.pos_emb is None:
            ...
            if mask is not None:
                ...
                padding_mask = torch.cat([torch.ones((batch_size, 1), dtype=torch.bool), padding_mask], dim=1)
                padding_mask = padding_mask.to(inputs.device).bool()
...
class AcT(nn.Module):
    ...
    def forward(self, inputs, lengths=None):
        ...
        if lengths is not None:
            ...
            # mask = mask.to(inputs.device).bool()
