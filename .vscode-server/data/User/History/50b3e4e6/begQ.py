...
class MultiHeadAttention(nn.Module):
    ...
    def register_attention_hook(self, hook):
            """Register a hook to obtain the attention weights."""
    ...
    def forward(self, q, k, v, mask=None):
            ...
            # Call the hook with attention weights if it exists
            if hasattr(self, '_attention_hook'):
                self._attention_hook(attention_weights)
