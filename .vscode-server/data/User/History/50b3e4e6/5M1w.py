...
class PatchClassEmbedding(nn.Module):
    ...
    def __init__(self, d_model, n_patches, seq_size, pos_emb=None):
        ...
        self.position_embedding = nn.Embedding(seq_size, self.d_model)
...
class AcT(nn.Module):
    def __init__(self, dropout, seq_size):
        ...
        self.patch_embed = PatchClassEmbedding(self.d_model, 30, seq_size)
