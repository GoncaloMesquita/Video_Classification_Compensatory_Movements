        ...
        for batch_idx, (inputs, targets, lengths, inputs2) in enumerate(val_loader):
            ...
            if saliency_map and mode == 'testing' :
                if method == 'ig':
                    ...
                    attributions.append(integrated_gradients(inputs, model, 0, baseline=None, steps=20))
...
def integrated_gradients(inputs, model, target_label_idx, baseline=None, steps=20):
    if baseline is None:
