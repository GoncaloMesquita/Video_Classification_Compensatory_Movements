...
def objective(trial):
    ...
    for epoch in range(epochs):
        train_loss = training(model, train_loader, optimizer, criterion, device, args.save_dir, args.model_name, threshold, clip_value, args.optuna, args.pretrained)
    ...
    for i in range(1):
        ...
        if args.mode == "train":
            ...
            for epoch in range(args.epochs):
                ...
                train_loss = training(model, train_loader, optimizer, criterion, device, args.save_dir, args.model_name, args.threshold, args.clip_value, args.optuna, args.pretrained)
