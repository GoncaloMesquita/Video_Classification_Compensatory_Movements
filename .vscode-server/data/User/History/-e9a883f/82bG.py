...
def objective(trial):
    ...
    for epoch in range(epochs):
        ...
        val_loss = validate(model, val_loader, criterion, device, "validation", args.save_dir, args.model_name, threshold, True)
...
if __name__ == "__main__":
    ...
    best_params_file = os.path.join(args.save_dir, f"{args.model_name}_best_parameters.txt")
