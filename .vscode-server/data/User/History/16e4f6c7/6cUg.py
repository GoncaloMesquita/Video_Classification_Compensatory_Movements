...
def collate_fn(batch):
    ...
    if model_name[0] == 'SkateFormer':
        ...
        sequences,  labels, sequences = sequences[:max_length], labels[:max_length], sequences2[:max_length]
    ...
    print(padded_sequences.shape,torch.tensor(labels).shape,lengths.shape)
