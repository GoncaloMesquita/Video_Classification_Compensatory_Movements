        ...
        if patient in [3, 11, 17] :
            ...
            if trial in trial_1:
                ...
                for j in trial_batch:
                    ...
                    sns.heatmap(map[trial_batch][0:lenghts[0]].T.detach().cpu().numpy(), cmap='RdYlBu', ax=axes[label], cbar_kws={'label': 'Normalized Saliency'})
                    ...
                    head_joints = map[trial_batch][0:lenghts[0], :].sum(dim=1).detach().cpu().numpy()
