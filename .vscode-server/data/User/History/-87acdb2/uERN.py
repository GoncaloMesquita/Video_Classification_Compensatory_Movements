...
class MomentDino(nn.Module):
    def __init__(self, num_classes, dropout, input_size, seq_length): 
        ...
        self.dino_processor = AutoImageProcessor.from_pretrained("facebook/dino-vits8")
        self.dinov2 = AutoModel.from_pretrained("facebook/dino-vits8", output_attentions=True)
