...
def train_I(args, dataset_name):
    ...
    cross_val_data, index_keep = load_data(args.data_label, args.data_skeletons, args.num_patients, args.input_size, args.mode)    
    
    if args.model_name == 'moment+dino':
        cross_val_data_2, true_data = load_data_video(args.data_label, args.data_trials, index_keep, args.trainII, args.num_patients) 
