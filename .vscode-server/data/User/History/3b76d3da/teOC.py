...
def objective(trial):
    ...
    for i , (X_t, y_t, X_test, y_test) in enumerate (data):
        ...
        train_loader = create_dataloader(X_train_standardized, y_t, batch_size, True, args.model_name, seq_size)
        val_loader = create_dataloader(X_val_standardized, y_val, batch_size, False, args.model_name, seq_size)
