...
def train_I(args, dataset_name):
    ...
    cross_val_data, index_keep, true_data = load_data(args.data_label, args.data_skeletons, args.num_patients, args.input_size, args.mode, args.num_dimensions)    
    ...
    for i , (X_t, y_t, X_test, y_test) in enumerate (cross_val_data):
        ...
        if args.mode == "train" or mode == "train":
            ...
            model, criterion, optimizer, scheduler, scaler = create_model(args.model_name, args.input_size, args.hidden_size, args.num_layers, args.num_labels, args.dropout, args.checkpoint, args.mode, args.pretrained, device, args.learning_rate, args.eta, args.epochs, args.seq_size, args.num_dimensions )
            model.to(device)
            ...
            model , criterion, optimizer, scheduler, scaler = create_model(args.model_name, args.input_size, args.hidden_size, args.num_layers, args.num_labels, args.dropout, args.checkpoint, "test", args.pretrained, device, args.learning_rate, args.eta, args.epochs, args.seq_size, args.num_dimensions)
            model.to(device)
            # if torch.cuda.device_count() > 1:
            ...
            pseudo_label(model, test_loader, device, args.save_dir, args.model_name, i, args.treshold_labels, args.method, dataset_name, true_data, args.input_size, args.num_dimensions)
            ...
            if i in args.vis_patients:
                ...
                visualization(model, test_loader, device, args.model_name, i, args.method ,args.vis_trials, args.batch_size, dataset_name, args.input_size, args.num_dimensions)
...
def train_II(args, dataset_name):
    ...
    cross_val_data = load_pseudo_label(args.data_skeletons, args.data_true_dir, args.data_pseudo_dir, args.first_label, args.true_labels, args.model_name, args.num_patients, args.input_size, args.num_dimensions)    
