    ...
    def classify(
        ...
        **kwargs,
        ...
        def forward_hook(module, input, output):
            self.activations = output.detach()  # Capture forward activations

        def backward_hook(module, grad_input, grad_output):
            self.gradients = grad_output[0].detach()  # Capture gradients during backpropagation

        for name, module in self.encoder.named_modules():
            if "layer" in name and "DenseReluDense.wo" in name:  # Target self-attention layers
